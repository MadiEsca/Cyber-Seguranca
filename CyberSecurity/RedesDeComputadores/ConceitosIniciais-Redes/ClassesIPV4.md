...
*Vale ressaltar que apenas o protocolo IP na versão 4 (IPV4) possui essas classes, enquanto sua versão 6 (IPV6) não possui classes.*
...
---
## Tipos de classe
Com isso, temos 5 classes de IPV4:
- Classe A
...
Dado determinado IP com o CIDR, calcule o valor da mascara de rede **192.168.0.1/27**
